                        ...
                        <div class="card-body py-0">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-sm-6">
                                    <div class="dz-image-bx rounded">
                                        <div class="dz-media active me-3">
                                            <img class="rounded" src="images/avatar/1.jpg" alt="">
                                        </div>
                                        <div class="dz-info">
                                ...
                                <div class="col-xl-6 col-sm-6">
                                    <div class="dz-image-bx rounded">
                                        <div class="dz-media active me-3">
                                            <img class="rounded" src="images/avatar/2.jpg" alt="">
                                        </div>
                                        <div class="dz-info">
                                ...
                                <div class="col-xl-6 col-sm-6">
                                    <div class="dz-image-bx rounded">
                                        <div class="dz-media me-3">
                                            <img class="rounded" src="images/avatar/3.jpg" alt="">
                                        </div>
                                        <div class="dz-info">
                                            <h5>Richard Smile</h5>
                                            <span class="text-primary">October 3th, 2020</span>
                                ...
                                <div class="col-xl-6 col-sm-6">
                                    <div class="dz-image-bx rounded">
                                        <div class="dz-media me-3">
                                            <img class="rounded" src="images/avatar/4.jpg" alt="">
                                        </div>
                                        <div class="dz-info">
                                            <h5>Bella Yen</h5>
                                            <span class="text-primary">October 3th, 2020</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-body customer-review-bx p-0 dz-scroll loadmore-content"
                                    id="customerReviewContent">
                                        ...
                                        <div class="dz-info">
                                            <div class="dz-name mb-3">
                                                <div>
                                                    ...
                                                    <span class="date text-black op8">Posted on 26/04/2020, 12:42
                                                        AM</span>
                                                </div>
                                            ...
                                            <div class="dz-footer">
                                                <p class="text-black op8 mb-sm-0 mb-3 me-4">I have been there many
                                                    times.Rooms ,Food and Service are excellent.we did lots of
                                                    Excursions and all the places are from the Hotel reachable. we
                                                    visited Long Waterfall and was very helpful and excellent</p>
                                                <a class="review-icon rounded-circle bg-success text-white me-3"
                                                    href="javascript:void(0);"><i class="far fa-check-circle"></i></a>
                                                <a class="review-icon rounded-circle bg-danger text-white"
                                                    href="javascript:void(0);"><i class="far fa-times-circle"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="dz-review-bx">
                                        <img class="dz-media me-4" src="images/avatar/2.jpg" alt="">
                                        <div class="dz-info">
                                            <div class="dz-name mb-3">
                                                <div>
                                    ...
                                    <div class="dz-review-bx">
                                        <img class="dz-media me-4" src="images/avatar/3.jpg" alt="">
                                        <div class="dz-info">
                                            <div class="dz-name mb-3">
                                                <div>
                                ...
                                <div class="card-footer style-1 border-0 pt-0 text-center">
                                    <a href="javascript:void(0);" class="dz-load-more fas fa-chevron-down"
                                        id="customerReview" rel="ajax/customer-review.html"></a>
                                </div>
                            </div>
                        </div>
                    </div>
