                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="index.html"><img src="images/logo-dark.png" class="dark-login" alt=""></a>
										<a href="index.html"><img src="images/logo-white.png" class="light-login" alt=""></a>
									</div>
                                    ...
                                    <form action="/login" method="post">
                                        ...
                                        <div class="mb-3 position-relative">
											...
											<input type="password" id="dz-password" name="password" class="form-control" value="123">
