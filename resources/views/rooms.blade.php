					...
					<div class="col-xl-12">
						<div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
							<div class="card-tabs mt-3 mt-sm-0 mb-xxl-0 mb-4">
								<ul class="nav nav-tabs" role="tablist">
									...
									<li class="nav-item">
										<a class="nav-link" data-bs-toggle="tab" href="#Pending" role="tab">Available Room (234)</a>
									</li>
									<li class="nav-item">
							...
							<a href="javascript:void(0);" class="btn btn-primary mb-xxl-0 mb-4 radius-btn" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="far fa-file-word me-2"></i>Generate Report</a>
						</div>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-0001</a></h4>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00011</a></h4>
														</div>
													</div>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00012</a></h4>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div>
														...
														<span class="fs-16">AC, Shower, Single Bed, Towel, Bathup,<br> Coffee Set, LED TV, Wifi</span>
													</div>
												</td>
												<td>
													<div>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00013</a></h4>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="guest-bx">
														<div id="carouselExampleControls" class="carousel slide me-3" data-bs-ride="carousel">
															<div class="carousel-inner">
																<div class="carousel-item active">
																	<img src="images/hotel/pic11.jpg" class="d-block w-100" alt="...">
																</div>
																<div class="carousel-item">
																	<img src="images/hotel/pic22.jpg" class="d-block w-100" alt="...">
																</div>
																<div class="carousel-item">
																	<img src="images/hotel/pic33.jpg" class="d-block w-100" alt="...">
																</div>
															</div>
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Deluxe B-00014</a></h4>
														</div>
													</div>
												</td>
												<td>
						...
						<div class="tab-content">	
							<div class="tab-pane" id="Pending">
								<div class="table-responsive">
									<table class="table card-table check-data  display mb-4 dataTablesCard booking-table room-list-tbl table-responsive-lg" id="guestTable-all-1">
										<thead>
											<tr>
												<th class="bg-none">
													<div class="form-check style-1">
										...
										<tbody>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00015</a></h4>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00016</a></h4>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00017</a></h4>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00018</a></h4>
														</div>
													</div>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<div class="guest-bx">
														<div id="carouselExampleControls-1" class="carousel slide me-3" data-bs-ride="carousel">
															<div class="carousel-inner">
																<div class="carousel-item active">
																	<img src="images/hotel/pic11.jpg" class="d-block w-100" alt="...">
																</div>
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Deluxe B-00019</a></h4>
														</div>
													</div>
												</td>
												<td>
						...
						<div class="tab-content">	
							<div class="tab-pane" id="Booked">
								<div class="table-responsive">
									<table class="table card-table check-data  display mb-4 dataTablesCard booking-table room-list-tbl table-responsive-lg" id="guestTable-all-2">
										<thead>
											<tr>
												<th class="bg-none">
													<div class="form-check style-1">
										...
										<tbody>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00028</a></h4>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00029</a></h4>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00030</a></h4>
														</div>
													</div>
												</td>
												<td>
												...
												<td>
													<div class="guest-bx">
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Queen A-00040</a></h4>
														</div>
													</div>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<div class="guest-bx">
														<div id="carouselExampleControls-2" class="carousel slide me-3" data-bs-ride="carousel">
															<div class="carousel-inner">
																<div class="carousel-item active">
																	<img src="images/hotel/pic11.jpg" class="d-block w-100" alt="...">
																</div>
														...
														<div>
															...
															<h4 class="mb-0 mt-1"><a class="text-black" href="guest-detail.html">Deluxe B-00050</a></h4>
														</div>
													</div>
												</td>
												<td>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="mb-3">
						  ...
						  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="AC, Shower, Double Bed, Towel, Bathup,Coffee Set, LED TV, Wifi">
						</div>
					</div>
					<div class="col-xl-6">
						 <label class="form-label d-block">Bed Type</label>
						<select class="nice-select me-sm-2 default-select form-control wide" aria-label="Default select example">
					...
					<div class="col-xl-6">
						<div class="mb-3">
						  ...
						  <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Floor G-05">
						</div>
					</div>
				</div>
			  </div>
